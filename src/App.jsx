...
function App() {
  useEffect(() => {
    ...
    const parquetTexture = new THREE.TextureLoader().load(
      "./assets/parquet.jpg"
    );
    const stoneTexture = new THREE.TextureLoader().load("./assets/pierre.jpg");
    const marbleTexture = new THREE.TextureLoader().load("./assets/marble.jpg")
    // set up ground
    ...
    const bm1 = new THREE.MeshStandardMaterial({
      map: parquetTexture,
    });
    const boxMesh1 = new THREE.Mesh(bg1, bm1);
    boxMesh1.castShadow = true;
    ...
    const bg3 = new THREE.SphereGeometry(0.7);
    const bm3 = new THREE.MeshStandardMaterial({
      map: marbleTexture,
      roughness: 0,
      metalness: 0.5
    });
